...
with conn.cursor() as cursor:
  cursor.execute("""CREATE TABLE IF NOT EXISTS benchmark ( id SERIAL PRIMARY KEY, benchmarks TEXT, filename TEXT, system TEXT)""")
  cursor.execute("""CREATE TABLE IF NOT EXISTS commits (id SERIAL PRIMARY KEY, sha TEXT)""")
